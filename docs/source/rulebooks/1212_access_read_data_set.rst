...
1212_access_read_data_set - Monitor zSecure alerts from Kafka for access >= READ on a sensitive data set
========================================================================================================
...
This rulebook monitors RACF when a user gains READ access or higher to a sensitive data set. The zSecure-generated event is a C2P1212I alert and is delivered through Kafka.
...
* **C2P1212I**: zSecure alert indicating that a user has accessed a sensitive data set with an access level of READ or higher.
