...
This rulebook monitors RACF whenever a user gains access of READ or higher to a sensitive data set. The event generated by zSecure is a C2P1212I alert and it is delivered through Kafka.
...
* Verify the C2P1212I events are published to Kafka.
